...
if __name__ == "__main__":
    # image_path = '/scratch/shashank/dataset/frames_amsterdam/frame_27611/patch_38.jpg'
    image_path = "/scratch/shashank/dataset/framesOnly_amsterdam/frame1695.jpg"
    transform = transforms.Compose(
        [
            # transforms.Resize(256, interpolation=3),
            transforms.RandomCrop(
                224
            ),  # , scale=(0.4, 1.), interpolation=Image.BICUBIC),
    ...
    # print(image.shape)
    pretrained_weights = (
        "/scratch/shashank/checkpoint/dino_WT/vanilla_512/checkpoint.pth"
    )
    model = vit_tiny()
    utils.load_pretrained_weights(model, pretrained_weights, "teacher", "vit_tiny", 16)
    output_dir = "/scratch/shashank/codes/dino/viz_attn/img4_avg_tmp/"
